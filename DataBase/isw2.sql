...
-- Tiempo de generación: 18-10-2021 a las 12:22:00
...
CREATE TABLE `acta` (
  ...
  `titulo_acta` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `contenido_acta` varchar(5000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `comunidad` (
  ...
  `nombre_comunidad` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `descripcion_comunidad` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(11, 'comunindad para entrega', 'esta comunidad es para sample de entrega');
...
(1, 'Reunion de no sé qué', '2022-12-12', '17:30', 'Parque acuatico', 'el parque acuatico es bacan', 2, '45f321b12939156dd082181bddebf119'),
(2, 'Reunion de no sé qué', '2022-12-12', '17:30', 'Parque acuatico', 'el parque acuatico es bacan', 2, '45f321b12939156dd082181bddebf119'),
(3, 'Reunión Product Owner', '2021-10-14', '13:40', 'Online', 'A', 1, '45f321b12939156dd082181bddebf119'),
(4, 'creo que', '2022-12-12', '12:30', 'en tu casa', 'reunion', 3, '45f321b12939156dd082181bddebf119'),
(5, 'Reunión Product Owner', '2021-10-14', '13:40', 'Online', 'asdqascd', 1, '45f321b12939156dd082181bddebf119'),
(6, 'Lomo Toros', '2021-10-14', '12:30', 'Online', 'Pablo Montoya', 7, '45f321b12939156dd082181bddebf119'),
(7, 'Lomo Toros', '2021-10-14', '12:30', 'Online', 'perrito suave', 7, '45f321b12939156dd082181bddebf119'),
...
--
ALTER TABLE `acta`
  MODIFY `id_acta` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `comunidad`
--
ALTER TABLE `comunidad`
  MODIFY `id_comunidad` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT de la tabla `reunion`
--
ALTER TABLE `reunion`
  MODIFY `id_reunion` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
